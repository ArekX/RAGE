...
extern void Init_callback(VALUE dl);
...
{
    rb_const_set(dl, rb_intern_const("CdeclCallbackAddrs"), Qundef);
    rb_const_set(dl, rb_intern_const("CdeclCallbackProcs"), Qundef);
#ifdef FUNC_STDCALL
    rb_const_set(dl, rb_intern_const("StdcallCallbackAddrs"), Qundef);
    rb_const_set(dl, rb_intern_const("StdcallCallbackProcs"), Qundef);
#endif
