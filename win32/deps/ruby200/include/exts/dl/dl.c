...
void Init_dl(void)
{
	...
	rb_define_module_function(rb_mDL, "dlwrap", RUBY_METHOD_FUNC(rb_dl_value2ptr), 1);
    rb_define_module_function(rb_mDL, "dlunwrap", RUBY_METHOD_FUNC(rb_dl_ptr2value), 1);

    rb_define_module_function(rb_mDL, "dlopen", RUBY_METHOD_FUNC(rb_dl_dlopen), -1);
    rb_define_module_function(rb_mDL, "malloc", RUBY_METHOD_FUNC(rb_dl_malloc), 1);
    rb_define_module_function(rb_mDL, "realloc", RUBY_METHOD_FUNC(rb_dl_realloc), 2);
    rb_define_module_function(rb_mDL, "free", RUBY_METHOD_FUNC(rb_dl_free), 1);
